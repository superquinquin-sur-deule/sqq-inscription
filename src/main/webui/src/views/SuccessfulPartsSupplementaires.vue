<template>
  <main class="container">
    <header class="header">
      <div class="brand">
        ...
        <div class="brand-text">
          ...
          <p class="subtitle">Ton paiement a bien été confirmé, tes parts additionnelles ont été ajoutées.</p>
        </div>
      </div>
    </header>
    ...
    <section class="section success">
      ...
      <h2>Souscription finalisée</h2>
      <p>
        Nous venons de valider ta souscription de parts additionnelles. Tu recevras un email de confirmation
        avec un récapitulatif de ta souscription et de ton paiement.
      </p>

      <div class="next-steps">
        <h3>Et maintenant ?</h3>
        <ul>
          <li>Surveille ta boite mail pour le récapitulatif</li>
          <li>Continue à soutenir SuperQuinquin sur Deûle !</li>
        </ul>
      </div>
